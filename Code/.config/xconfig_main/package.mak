...
package/cfg/main_pem4f.xdc.inc: package/cfg/main_pem4f.xdl
package/cfg/main_pem4f.xdl package/cfg/main_pem4f.c: .interfaces
...
main.xem4f: package/cfg/main_pem4f.oem4f 
	...
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/main_pem4f.oem4f   package/cfg/main_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
